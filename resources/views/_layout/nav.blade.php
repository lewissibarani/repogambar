                            ...
                            <li class="mb-3 pb-3 border-bottom border-separator-light ">
                                <div class="row align-items-start ">
                                    ...
                                    <div id="icon-mark-as-read" class="col col-lg-1 align-self-center">
                                        <div class="sw-1 me-3">
                                        <div class="bg-gradient-light sw-2 sh-2 rounded-xl d-flex justify-content-center align-items-center">
                                        </div> 
                                        </div>
                                    </div>
                                    @else
                                    <div id="icon-mark-as-read" class="col col-lg-1 align-self-center">
                                        <div class="sw-1 me-3">
                                        <div class="sw-2 sh-2 rounded-xl d-flex justify-content-center align-items-center border border-primary">
                                        </div> 
                                        </div>
                                    </div>
                                    @endif
