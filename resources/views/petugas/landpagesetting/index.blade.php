@php
    ...
    $breadcrumbs = ["/"=>"Home","/landpagesetting"=>"Daftar Koleksi Penting"]
@endphp
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12 d-flex align-items-start justify-content-left">
                                                        <section class="scroll-section" id="default">
                                                            ...
                                                            <button id="modalstoreLandpageSetting" type="button" class="btn btn-primary btn-icon btn-icon-start add-datatable"
                                                                href="">
                                                                    <i data-acorn-icon="plus"></i>
                                                                    <span>Tambah Baru</span>
                                                            </button>
                                ...
                                >
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-muted text-small text-uppercase">Nama Koleksi</th>
                                        <th class="text-muted text-small text-uppercase">Tagname</th>
                                        <th class="text-muted text-small text-uppercase">Pembuat Koleksi</th>
                ...
                @include('petugas.landpagesetting.modalstore') 
        </div>
    </div> 
...
<script>
    ...
    var ENDPOINT = "{{route('landpagesetting.create')}}";
    if ('{{ env('APP_ENV') }}' == 'production')
    {
        ENDPOINT = "https://webapps.bps.go.id/pikart/landpagesetting/create";
    }
      
   
  
    $("#modalstoreLandpageSetting").click(function (e) {
        $.ajaxSetup({
            headers: {
