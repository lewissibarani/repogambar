<div class="modal fade show" id="modalrinciankuesioner" tabindex="-1" role="dialog" aria-labelledby="scrollingModalLabel" aria-modal="true">
    <div class="modal-dialog modal-semi-full modal-dialog-scrollable ">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="scrollingModalLabel">Rincian Tabel Kuesioner Adobe CC 2024</h5>
