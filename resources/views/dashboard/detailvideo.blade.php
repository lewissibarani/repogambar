                ...
                <div class="card mb-5">
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="row">
                                <div class="col 6">
                                    <h4 class="mb-3 font-weight-bold">Penyumbang Video </h4>
                                ...
                                <div class="col 6">
                                    <h4 class="mb-3 font-weight-bold">Format Video </h4>
                                    <div> 
                                        <p>
                                         {{$imageekstension}} {{$image_info_file}}| {{$image_size}} MB
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mb-n2">
                            <div class="col-12 col-md-6 col-xl-12">
                                ...
                                <div class="mt-5 col-12">
                                    <h2 class="small-title">Video Terkait Lainnya</h2>
                                    <div class="mb-5">
                                        <div class="row mb-n2">
